...
const CatalogFilter = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 w-full lg:w-64 flex-shrink-0 self-start lg:sticky lg:top-28">
      <div className="flex justify-between items-center mb-4 lg:mb-6">
        <h2 className="text-lg font-bold text-gray-900">Filter Results</h2>
        <button 
          className="lg:hidden text-sm font-medium text-blue-600 hover:text-blue-800"
      ...
      <div className={`${isMobileOpen ? 'block' : 'hidden'} lg:block transition-all duration-300`}>
        {/* Format Filter */}
        <div className="mb-6">
