...
/**
 * Seeds the user_db with mock users on application startup if the database is empty.
 * Creates one ADMIN, one STAFF, and several CUSTOMER accounts for testing purposes.
 */
@Component
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("DataSeeder: Successfully seeded {} users.", users.size());
        log.info("DataSeeder: Credentials summary:");
        log.info("  ADMIN   -> admin@elib.com      / Admin@123");
        log.info("  STAFF   -> staff@elib.com      / Staff@123");
        log.info("  CUSTOMER-> alice.murphy@example.com / Customer@123");
        log.info("  CUSTOMER-> bob.obrien@example.com   / Customer@123");
        log.info("  CUSTOMER-> clara.walsh@example.com  / Customer@123");
    }
}
